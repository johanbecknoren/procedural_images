...
#define TEXTUREFILENAME PATH "textures/trex.tga"
...
int main(int argc, char *argv[]) {
	...
	std::cout<<"glewInit succeded!" << std::endl;
	...
	//soupCreateSphere(&myShape, 1.0, 1000);
	soupReadOBJ(&myShape, "meshes/trex.obj");
	//soupReadOBJ(&myShape, "meshes/teapot.obj");
